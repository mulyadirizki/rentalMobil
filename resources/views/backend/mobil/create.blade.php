...
<!-- Content -->
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-xxl">
            ...
            <div class="card-body">
                <form action="{{ route('addMobil') }}" method="post" id="add-mobil" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
        ...
        $('#add-mobil').submit(function (e) {
            ...
            $.ajax({
				...
				success: function(response) {
					Swal.fire({
						icon: 'success',
						title: 'Tambah data mobil berhasil',
						timer: 1500
					})
                    .then (function () {
