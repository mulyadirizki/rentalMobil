...
<!-- Content -->
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-xxl">
            ...
            <div class="card-body">
                <form action="{{ route('addRekeningStore') }}" method="post" id="add-mobil" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="nama_rek">Nama Pemilik</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_rek" name="nama_rek" placeholder="Nama Pemilik Rekening" />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="jenis_bank">Nama Bank</label>
                        <div class="col-sm-10">
                        <input
                            type="text"
                            class="form-control"
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="no_rek">No Rekening</label>
                        <div class="col-sm-10">
        ...
        $('#add-mobil').submit(function (e) {
            ...
            $.ajax({
				...
				success: function(response) {
					Swal.fire({
						icon: 'success',
						title: 'Tambah data Rekening berhasil',
						timer: 1500
					})
                    .then (function () {
				...
				error: function(err) {
					alert('Tambah data Rekening gagal')
				}
			});
        });
    </script>
